...
class Hero:
    def __init__(self):
        self.moving_state: MovementState = StationaryState(self)
        self.playing_state: PlayableState = PlayingState(self)
    ...
    def set_state(self, new_state_cls: type[MovementState], action=None):
...
hero = Hero()
hero.moving_state.to_movement()
hero.playing_state.to_finished()
print("----")
print(f"État actuel du héros : {hero.moving_state.name}")
print("----")
hero.moving_state.to_movement()
print("----")
print(f"État actuel du héros : {hero.moving_state.name}")
print("----")
hero.moving_state.to_stationary()
print("----")
print(f"État actuel du héros : {hero.moving_state.name}")
print("----")